...
public class WireRecipeHandler {
    ...
    static {
        INSULATION_MATERIALS.put(Materials.Rubber, GTValues.MV);
        INSULATION_MATERIALS.put(Materials.StyreneButadieneRubber, GTValues.EV);
        INSULATION_MATERIALS.put(Materials.SiliconeRubber, GTValues.IV);
    }
