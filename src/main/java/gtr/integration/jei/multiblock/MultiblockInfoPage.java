...
public abstract class MultiblockInfoPage {
    ...
    private static final ITextComponent defaultText = new TextComponentTranslation("gtr.multiblock.preview.any_hatch").setStyle(new Style().setColor(TextFormatting.GREEN));
    ...
    public List<String> informationText() {
        ...
        return Stream.of("gtr.multiblock.preview.tilt", "gtr.multiblock.preview.zoom",
            "gtr.multiblock.preview.pan", "gtr.multiblock.preview.move", "gtr.multiblock.preview.reset")
            .map(I18n::format)
