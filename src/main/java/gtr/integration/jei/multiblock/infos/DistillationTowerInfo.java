...
public class DistillationTowerInfo extends MultiblockInfoPage {
    ...
    protected void generateBlockTooltips() {
        ...
        ITextComponent tooltip = new TextComponentTranslation("gtr.multiblock.preview.limit_per_layer", 1).setStyle(new Style().setColor(TextFormatting.DARK_RED));
        ITextComponent inputTooltip = new TextComponentTranslation("gtr.multiblock.preview.only_location", I18n.format("gtr.multiblock.preview.location.b_c")).setStyle(new Style().setColor(TextFormatting.DARK_RED));
