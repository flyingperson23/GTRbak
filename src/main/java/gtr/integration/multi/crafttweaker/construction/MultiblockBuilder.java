package gtr.integration.multi.crafttweaker.construction;
...
import gtr.integration.multi.gregtech.cuberenderer.SidedCubeRenderer;
...
public class MultiblockBuilder {
    ...
    public int metaId;
    public gtr.api.render.ICubeRenderer texture = null;
     ...
     */
    @ZenMethod
    public MultiblockBuilder withPattern(@Nonnull IBlockPattern pattern) {
     ...
     */
    @ZenMethod
    public MultiblockBuilder withRecipeMap(@Nonnull RecipeMap<?> map) {
        this.recipeMap = map;
        return this;
    }
     ...
     */
    @ZenMethod
    public MultiblockBuilder withTexture(@Nonnull IICubeRenderer texture) {
     ...
     */
    @ZenMethod
    public MultiblockBuilder addDesign(@Nonnull IMultiblockShapeInfo... designs) {
