...
import gtr.integration.multi.jei.MultiblockTweakerJEIPlugin;
...
public class PreviewRenderer {
    ...
    private static final BlockPos DEFAULT_POS = BlockPos.ORIGIN.offset(EnumFacing.DOWN);
    ...
    public boolean onUse(World world, BlockPos pos, boolean isRightClick) {
        ...
        renderedBlocks = renderer.renderedBlocks;
