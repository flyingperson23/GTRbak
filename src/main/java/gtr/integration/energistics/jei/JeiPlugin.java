package gtr.integration.energistics.jei;
...
public class JeiPlugin implements IModPlugin {
    ...
    public void register(IModRegistry registry)
    {
        ...
        mezz.jei.collect.Table<Class<?>, String, IRecipeTransferHandler> collectedRegistry =
...
/*
    ...
    protected static <T, U> mezz.jei.collect.Table collectNonPatternTerminals(Table<Class, T, U> transferHandlers) {
        mezz.jei.collect.Table<Class<?>, T, U> newRegistry = mezz.jei.collect.Table.hashBasedTable();
        for (final Table.Cell<Class, T, U> currentCell : transferHandlers.cellSet()) {
            Class<?> rowKey = currentCell.getRowKey();
            if(rowKey == null)
                continue;
