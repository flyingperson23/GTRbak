package gtr.integration.energistics.gui;
...
public class StockerTerminalGuiContainer extends AEBaseGui {
    ...
    public void drawFG(final int offsetX, final int offsetY, final int mouseX, final int mouseY) {
        this.fontRenderer.drawString(I18n.format("gui.gtr.terminal.stocker"),
            8, 6, 4210752);
        this.fontRenderer.drawString(I18n.format("gui.gtr.terminal.inventory"),
