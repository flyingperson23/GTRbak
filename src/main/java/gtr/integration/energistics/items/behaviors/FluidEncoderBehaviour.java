...
import gtr.integration.energistics.gui.ModularUIItemBuilder;
import gtr.integration.energistics.items.AEItems;
import gtr.integration.energistics.items.StandardModMetaItem;
...
import gtr.api.gui.widgets.PhantomFluidWidget;
import gtr.api.gui.widgets.SimpleTextWidget;
import gtr.api.items.gui.ItemUIFactory;
import gtr.api.items.gui.PlayerInventoryHolder;
...
public class FluidEncoderBehaviour implements IItemBehaviour, ItemUIFactory {
    ...
    public void addInformation(ItemStack stack, List<String> lines) {
        ...
        MetaItem<?>.MetaValueItem heldMetaItem = AEItems.getMetaValueItemFromStack(stack);
    ...
    public ModularUI createUI(PlayerInventoryHolder holder, EntityPlayer entityPlayer) {
        ...
        MetaItem<?>.MetaValueItem heldMetaItem = AEItems.getMetaValueItemFromStack(heldItemStack);
        String baseName = "metaitem." + heldMetaItem.unlocalizedName;
