...
import gtr.api.recipes.builders.*;
...
@ZenClass("mods.gtr.recipe.RecipeMaps")
@ZenRegister
public class RecipeMaps {
    ...
    @ZenProperty
    public static final RecipeMap<IntCircuitRecipeBuilder> ASSEMBLER_RECIPES = new RecipeMap<>("assembler", 1, 9, 1, 1, 0, 3, 0, 0, new AssemblerRecipeBuilder())
    ...
    @ZenProperty public static final RecipeMap<IntCircuitRecipeBuilder> FLUID_HEATER_RECIPES = new RecipeMap<>("fluid_heater", 0, 1, 0, 0, 1, 2, 1, 2, new IntCircuitRecipeBuilder())
        .setProgressBar(GuiTextures.PROGRESS_BAR_ARROW, MoveType.HORIZONTAL);
    ...
    @ZenProperty
    public static final RecipeMap<SimpleRecipeBuilder> CRACKING_RECIPES = new RecipeMap<>("cracker", 0, 0, 0, 0, 2, 2, 1, 1, new SimpleRecipeBuilder());
