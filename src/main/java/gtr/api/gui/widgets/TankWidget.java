    ...
    public void drawInForeground(int mouseX, int mouseY) {
        if (!hideTooltip && !gui.isJEIHandled && isMouseOverElement(mouseX, mouseY)) {
            ...
            if (lastFluidInTank != null) {
                ...
                tooltips.add(I18n.format("gtr.fluid.empty"));
                tooltips.add(I18n.format("gtr.fluid.amount", 0, lastTankCapacity));
            }
            if (allowClickFilling) {
                tooltips.add(""); //add empty line to separate things
                tooltips.add(I18n.format("gtr.fluid.click_to_fill"));
                tooltips.add(I18n.format("gtr.fluid.click_to_fill.shift"));
            }
            if (allowClickEmptying) {
                tooltips.add(""); //add empty line to separate things
                tooltips.add(I18n.format("gtr.fluid.click_to_empty"));
                tooltips.add(I18n.format("gtr.fluid.click_to_empty.shift"));
            }
