package gtr.api.items.materialitem;
...
public class MaterialSetModelGen {
    ...
    public static void main(String[] args) throws Exception {
        File gtrRoot = new File("src/main/resources/assets/gtr");
        File modelsRoot = new File(gtrRoot, "models/item/material_sets");
        File texturesRoot = new File(gtrRoot, "textures/items/material_sets");
        modelsRoot.mkdirs();
            ...
            if (file.isDirectory()) {
                ...
                for (File child : file.listFiles()) {
                    ...
                    if (name.endsWith(".png") && !name.endsWith("_overlay.png")) {
                        ...
                        String texturePath = "gtr:items/material_sets/" + file.getName() + "/" + name;
