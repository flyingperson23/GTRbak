...
public class MessageReturnConnections implements IMessage {
    ...
    public void toBytes(ByteBuf buf) {
        ...
        buf2.writeVarIntArray(GTUtility.toIntArr(connectionBlock.connections));
    }
    ...
    public void fromBytes(ByteBuf buf) {
        ...
        try {
            ...
            ArrayList<EnumFacing> connections = GTUtility.toArrayList(buf2.readVarIntArray());
            this.connectionBlock = new ConnectionBlock(pos, connections);
        } catch (Exception e) {
            GTLog.logger.log(Level.ERROR, "Something went wrong trying to receive a packet");
        }
    }
