...
public class QuantumSuitJetpack extends QuantumSuit {
...
//        if (player.onGround) hoverMode = false;
        ...
        if (canShare && !world.isRemote) {
            ...
            for (int i = 0; i < player.inventory.armorInventory.size(); i++) {
                ...
                if (player.inventory.armorInventory.get(i).isItemEqual(MetaItems.QUANTUM_SUIT_JETPACK.getStackForm()))
                    continue;
        ...
        if (flyEnabled && cont.canUse(energyPerUse)) {
            if (hoverMode && !player.onGround) {
                ...
                if (ArmorUtils.isKeyDown(player, EnumKey.LEFT)) {
                    player.moveRelative(0.5F, 0.0F, 0.0F, 0.2F);
                }
                ...
                if (ArmorUtils.isKeyDown(player, EnumKey.BACK)) {
                    player.moveRelative(0.0F, 0.0F, -0.5F, 0.2F);
                }
                ...
                if (ArmorUtils.isKeyDown(player, EnumKey.JUMP)) {
                    ...
                    if (ArmorUtils.isKeyDown(player, EnumKey.FORWARD)) {
                        if (ArmorUtils.isKeyDown(player, EnumKey.BOOST)) {
                            player.moveRelative(0.0F, 0.0F, 3.0F, 0.20F);
                            energyUsageMultiplier = 1.5F;
                        } else {
                    ...
                    if (ArmorUtils.isKeyDown(player, EnumKey.LEFT)) {
                        if (ArmorUtils.isKeyDown(player, EnumKey.BOOST)) {
                            player.moveRelative(3.0F, 0.0F, 0.0F, 0.20F);
                            energyUsageMultiplier = 1.5F;
                        } else {
                            player.moveRelative(1.0F, 0.0F, 0.0F, 0.1F);
                        }
                    }
                    if (ArmorUtils.isKeyDown(player, EnumKey.RIGHT)) {
                        if (ArmorUtils.isKeyDown(player, EnumKey.BOOST)) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
        return "gtr:textures/armor/advanced_quark_tech_suite_1.png";
    }
