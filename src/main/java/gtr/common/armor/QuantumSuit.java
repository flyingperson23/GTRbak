...
public class QuantumSuit extends ArmorLogicSuite {
    protected static final Map<Potion, Integer> potionRemovalCost = new IdentityHashMap<>();
    private float charge = 0.0F;

    public QuantumSuit(EntityEquipmentSlot slot, int energyPerUse, int capacity, int tier) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
        ...
        ItemStack advancedChest = MetaItems.QUANTUM_SUIT_JETPACK.getStackForm();
