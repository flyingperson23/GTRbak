package gtr.common.items.potions;
...
import static gtr.common.MetaFluids.AUTO_GENERATED_FLUID_TEXTURE;
...
public class PotionFluids {
    ...
    public void onCapabilityAttach(AttachCapabilitiesEvent<ItemStack> event) {
        ...
        if (itemStack.getItem() instanceof ItemPotion) {
            ResourceLocation resourceLocation = new ResourceLocation("gtr", "fluid_container");
