package gtr.common.datafix.fixes.metablockid;


import com.google.common.collect.ImmutableList;
import gtr.api.GTValues;
import gtr.api.unification.material.type.Material;
import gtr.api.util.Version;
...
public class MetaBlockIdFixHelper {
    ...
    public static final Version V1_10_5 = new Version(1, 0, 0); // granite was added in 1.10.5
    public static final Version V1_14_0 = new Version(1, 6, 0); // meta block id alloc was changed in 1.14.0
