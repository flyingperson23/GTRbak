...
public class MetaTileEntityTank extends MetaTileEntity implements IFastRenderMetaTileEntity {
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, boolean advanced) {
        tooltip.add(I18n.format("gtr.universal.tooltip.fluid_storage_capacity", tankSize));
        tooltip.add(I18n.format("gtr.machine.fluid_tank.max_multiblock", maxSizeHorizontal, maxSizeVertical, maxSizeHorizontal));
