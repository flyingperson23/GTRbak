...
public class MetaTileEntityQuantumChest extends MetaTileEntity implements ITieredMetaTileEntity {
    ...
    protected void addDisplayInformation(List<ITextComponent> textList) {
        textList.add(new TextComponentTranslation("gtr.machine.quantum_chest.items_stored"));
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("gtr.machine.quantum_chest.capacity", maxStoredItems));
        ...
        if (compound != null) {
            ...
            if (translationKey != null) {
                tooltip.add(I18n.format("gtr.machine.quantum_chest.tooltip.item",
                    I18n.format(translationKey)));
                tooltip.add(I18n.format("gtr.machine.quantum_chest.tooltip.count", count));
            }
        }
    }
