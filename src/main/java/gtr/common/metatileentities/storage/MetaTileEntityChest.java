...
import gtr.api.gui.widgets.SortingButtonWidget;
...
public class MetaTileEntityChest extends MetaTileEntity implements IFastRenderMetaTileEntity {
    ...
    protected ModularUI createUI(EntityPlayer entityPlayer) {
        ...
        builder.widget(new SortingButtonWidget(111, 4, 60, 10, "gtr.gui.sort",
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, boolean advanced) {
        tooltip.add(I18n.format("gtr.universal.tooltip.item_storage_capacity", rowSize * amountOfRows));
    }
}
