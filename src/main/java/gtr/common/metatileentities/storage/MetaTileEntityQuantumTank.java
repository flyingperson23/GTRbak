...
public class MetaTileEntityQuantumTank extends MetaTileEntity implements ITieredMetaTileEntity {
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("gtr.machine.quantum_tank.capacity", maxFluidCapacity));
        ...
        if (compound != null && compound.hasKey("FluidName")) {
            ...
            tooltip.add(I18n.format("gtr.machine.quantum_tank.tooltip.name", fluidStack.getLocalizedName()));
            tooltip.add(I18n.format("gtr.machine.quantum_tank.tooltip.count", compound.getInteger("Amount")));
        }
    }
