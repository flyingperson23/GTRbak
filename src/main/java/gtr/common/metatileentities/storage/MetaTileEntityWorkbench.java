...
import gtr.api.gui.widgets.TabGroup.TabLocation;
import gtr.api.gui.widgets.tab.ItemTabInfo;
...
import gtr.common.gui.widget.CraftingSlotWidget;
import gtr.common.gui.widget.ItemListGridWidget;
import gtr.common.gui.widget.MemorizedRecipeWidget;
import gtr.common.inventory.IItemList;
import gtr.common.inventory.itemsource.ItemSourceList;
import gtr.common.inventory.itemsource.sources.InventoryItemSource;
...
public class MetaTileEntityWorkbench extends MetaTileEntity {
    ...
    private AbstractWidgetGroup createItemListTab() {
        WidgetGroup widgetGroup = new WidgetGroup();
        widgetGroup.addWidget(new LabelWidget(5, 20, "gtr.machine.workbench.storage_note_1"));
        widgetGroup.addWidget(new LabelWidget(5, 30, "gtr.machine.workbench.storage_note_2"));
        CraftingRecipeResolver recipeResolver = getRecipeResolver();
    ...
    protected ModularUI createUI(EntityPlayer entityPlayer) {
        ...
        tabGroup.addTab(new ItemTabInfo("gtr.machine.workbench.tab.workbench", new ItemStack(Blocks.CRAFTING_TABLE)), createWorkbenchTab());
        tabGroup.addTab(new ItemTabInfo("gtr.machine.workbench.tab.item_list", new ItemStack(Blocks.CHEST)), createItemListTab());
