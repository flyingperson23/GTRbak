...
import gtr.api.gui.widgets.ServerWidgetGroup;
import gtr.api.gui.widgets.SlotWidget;
import gtr.api.metatileentity.IFastRenderMetaTileEntity;
...
import gtr.loaders.recipe.CraftingComponent;
...
public class MetaTileEntityLockedSafe extends MetaTileEntity implements IFastRenderMetaTileEntity {
    ...
    private CountableIngredient[] getUnlockComponents() {
        ...
        return new CountableIngredient[] {
            new CountableIngredient(createIngredient(CraftingComponent.CIRCUIT.getIngredient(0)), 1),
    ...
    protected ModularUI createUI(EntityPlayer entityPlayer) {
        ...
        lockedGroup.addWidget(new LabelWidget(5, 20, "gtr.machine.locked_safe.malfunctioning"));
        lockedGroup.addWidget(new LabelWidget(5, 30, "gtr.machine.locked_safe.requirements"));
