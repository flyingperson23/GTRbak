...
public class MetaTileEntityFusionMaterialExtractor extends MetaTileEntityMultiblockPart implements IMultiblockAbilityPart<IFluidTank> {

    private static final int INITIAL_INVENTORY_SIZE = 8000;
    private ItemStackHandler containerInventory;
    public boolean isActive;

    public MetaTileEntityFusionMaterialExtractor(ResourceLocation metaTileEntityId) {
    ...
    public MetaTileEntity createMetaTileEntity(MetaTileEntityHolder holder) {
        return new MetaTileEntityFusionMaterialExtractor(metaTileEntityId);
    }
    ...
    public void renderMetaTileEntity(CCRenderState renderState, Matrix4 translation, IVertexOperation[] pipeline) {
        ...
        SimpleCubeRenderer top = isActive ? Textures.ACTIVE_FUSION_BASE : Textures.FUSION_BASE;
        SimpleCubeRenderer sides = Textures.FUSION_SIDE_2;
