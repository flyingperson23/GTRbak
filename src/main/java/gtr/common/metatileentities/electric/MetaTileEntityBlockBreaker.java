...
import gtr.api.util.BlockUtility;
import gtr.api.util.GregFakePlayer;
...
public class MetaTileEntityBlockBreaker extends TieredMetaTileEntity {
    ...
    private void addToInventoryOrDropItems(List<ItemStack> drops) {
        ...
        double itemSpawnY = getPos().getX() + 0.5 + outputFacing.getXOffset();
        double itemSpawnZ = getPos().getX() + 0.5 + outputFacing.getXOffset();
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, boolean advanced) {
        tooltip.add(I18n.format("gtr.universal.tooltip.item_storage_capacity", getInventorySize()));
        tooltip.add(I18n.format("gtr.machine.block_breaker.speed_bonus", (int) (getEfficiencyMultiplier() * 100)));
        tooltip.add(I18n.format("gtr.machine.block_breaker.consumption", getEnergyPerBlockBreak()));
    }
}
