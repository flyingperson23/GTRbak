...
import gtr.api.gui.widgets.ClickButtonWidget;
import gtr.api.gui.widgets.ImageWidget;
import gtr.api.gui.widgets.SimpleTextWidget;
...
import gtr.common.covers.filter.ItemFilterContainer;
...
public class MetaTileEntityItemCollector extends TieredMetaTileEntity {
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, boolean advanced) {
        tooltip.add(I18n.format("gtr.machine.item_collector.collect_range", maxItemSuckingRange, maxItemSuckingRange));
        tooltip.add(I18n.format("gtr.universal.tooltip.max_voltage_in", energyContainer.getInputVoltage(), GTValues.VN[getTier()]));
        tooltip.add(I18n.format("gtr.universal.tooltip.energy_storage_capacity", energyContainer.getEnergyCapacity()));
        tooltip.add(I18n.format("gtr.machine.item_controller.tooltip.redstone"));
        tooltip.add(I18n.format("gtr.machine.item_controller.tooltip.consumption", getEnergyConsumedPerTick()));
    }
    ...
    protected ModularUI createUI(EntityPlayer entityPlayer) {
        ...
        builder.widget(new SimpleTextWidget(88, 30, "gtr.machine.item_collector.gui.collect_range", 0xFFFFFF, () -> Integer.toString(itemSuckingRange)));
