...
import gtr.api.capability.impl.EnergyContainerBatteryBuffer;
...
public class MetaTileEntityBatteryBuffer extends TieredMetaTileEntity implements IControllable {
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("gtr.universal.tooltip.item_storage_capacity", inventorySize));
        ...
        tooltip.add(I18n.format("gtr.universal.tooltip.amperage_out_till", inventorySize));
