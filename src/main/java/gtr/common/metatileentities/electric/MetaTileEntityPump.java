...
public class MetaTileEntityPump extends TieredMetaTileEntity {
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, boolean advanced) {
        int maxPumpRange = getMaxPumpRange();
        tooltip.add(I18n.format("gtr.machine.pump.tooltip_range", maxPumpRange, maxPumpRange));
        tooltip.add(I18n.format("gtr.machine.pump.tooltip_speed", getPumpingCycleLength()));
