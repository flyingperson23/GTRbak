...
public class MetaTileEntityTransformer extends TieredMetaTileEntity {
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("gtr.machine.transformer.tooltip_tool_usage"));
        tooltip.add(I18n.format("gtr.universal.tooltip.energy_storage_capacity", energyContainer.getEnergyCapacity()));
        tooltip.add(I18n.format("gtr.machine.transformer.tooltip_transform_down"));
        tooltip.add(I18n.format("gtr.universal.tooltip.voltage_in", higherVoltage, higherTierName));
        tooltip.add(I18n.format("gtr.universal.tooltip.voltage_out", lowerVoltage, lowerTierName));
        tooltip.add(I18n.format("gtr.universal.tooltip.amperage_in", lowerAmperage));
        tooltip.add(I18n.format("gtr.universal.tooltip.amperage_out", higherAmperage));
        tooltip.add(I18n.format("gtr.machine.transformer.tooltip_transform_up"));
        tooltip.add(I18n.format("gtr.universal.tooltip.voltage_in", lowerVoltage, lowerTierName));
        tooltip.add(I18n.format("gtr.universal.tooltip.voltage_out", higherVoltage, higherTierName));
        tooltip.add(I18n.format("gtr.universal.tooltip.amperage_in", higherAmperage));
        tooltip.add(I18n.format("gtr.universal.tooltip.amperage_out", lowerAmperage));
    }
}
