...
public class CommandHand extends CommandBase {
    ...
    public String getUsage(ICommandSender sender) {
        return "gtr.command.util.hand.usage";
    }
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        if (sender instanceof EntityPlayerMP) {
            ...
            if (stackInHand.isEmpty()) {
                throw new CommandException("gtr.command.util.hand.no_item");
            }
            ...
            player.sendMessage(new TextComponentTranslation("gtr.command.util.hand.item_id", registryName, stackInHand.getItemDamage())
            ...
            if (electricItem != null) {
                player.sendMessage(new TextComponentTranslation("gtr.command.util.hand.electric",
            ...
            if (fluidHandlerItem != null) {
                for (IFluidTankProperties properties : fluidHandlerItem.getTankProperties()) {
                    ...
                    player.sendMessage(new TextComponentTranslation("gtr.command.util.hand.fluid",
                        fluidName,
            ...
            if (stackInHand.getItem() instanceof MetaItem) {
                ...
                if (metaValueItem == null) {
                    if (metaItem instanceof MaterialMetaItem) {
                        ...
                        player.sendMessage(new TextComponentTranslation("gtr.command.util.hand.material_meta_item", orePrefix, material)
            ...
            throw new CommandException("gtr.command.util.hand.not_a_player");
        }
    }
}
